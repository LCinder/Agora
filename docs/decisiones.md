...
**Cuenta altas, nunca bajas, y es a propósito.** Un vecino que desmarca un evento tres meses después no puede des-ocurrir el interés que mostró en junio, y decidir de qué mes descontarlo es una pregunta sin buena respuesta. Así que la serie se llama lo que es: **«Asistentes por mes»**. El contador de cada evento sí baja al desmarcar, porque ese número responde a otra pregunta — cuánta gente está interesada ahora.
